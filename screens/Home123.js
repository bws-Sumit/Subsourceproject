    ...
    >
      ...
      <View style={{ height: 160, width: 350, backgroundColor: "#FFF",}}>
           ...
           <View style={{ height: 222, width: 350, backgroundColor: "#FFF", borderRadius: 16, borderWidth: 1, borderColor: "#00933B",marginVertical:15 }}>
             ...
             <TouchableOpacity style={{ width: 20, height: 20, left: 25, top: 17 }} onPress={() => navigation.navigate('Homepage', { name: 'Homepage' })}>
              <Image source={require('../images/rightdark.png')} />
             </TouchableOpacity >
            <Text style={{ fontSize: 16, fontWeight: 500, color: "#222", left: 64, top: -3 }}>02 June 2023</Text>
            <TouchableOpacity style={{ width: 20, height: 20, left: 173, top: -27 }} onPress={() => navigation.navigate('Homepage', { name: 'Homepage' })}>
               <Image source={require('../images/leftdark.png')} />
             </TouchableOpacity>
            ...
            <Text style={{ fontSize: 14, fontWeight: 500, color: "#222", left: 50, top: -35 }}>wed, 03 June (3:30am-6:00pm) 2:30 hrs</Text>
             ...
             <TouchableOpacity style={{ width: 20, height: 20, left: 305, top: -160 }}>
